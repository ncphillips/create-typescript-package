...
cd packages/create-typescript-package
...
ctp_path="$root_path"/packages/create-typescript-package/`npm pack`
...
# If Yarn is installed, clean its cache because it may have cached create-typescript-package
