...
# ******************************************************************************
# This creates an app with the global CLI and `type-scripts` from the source.
...
scripts_path="$root_path"/packages/type-scripts/`npm pack`
...
cd "$root_path"
node packages/create-typescript-package/index.js --scripts-version="$scripts_path" "$@"
